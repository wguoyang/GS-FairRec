...
shiyanmiaoshu='去敏感信息，职业,加上RecFair,,FairGo，'
f = open('ml1m_occ_result.txt', 'a')
...
class InforMax(nn.Module):
    ...
    def forward(self, adj_pos,user_batch,rating_batch,item_batch):      
        ...
        user_person_f = user_f3_tmp
        item_person_f = item_f3_tmp#gcn_items_embedding0#item_f2_tmp#gcn_items_embedding0#item_f2_tmp
...
# user_select=np.load('./select/user_select_0.5_occ.npy',allow_pickle=True)
...
if __name__ == '__main__':
    for epoch in range(150):
        ...
        user_e = user_e_f3
        item_e = item_e_f3#items_emb_gcn#item_e_f2#items_emb_gcn
        ...
        precision_Att = FairMetric.get_Att_precision(user_e, item_e, 'occ')
