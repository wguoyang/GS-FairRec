...
def clf_gender_all_pre(model_id,epoch_run,users_embs,factor_num):
    ...
    # user_feature=np.load('../data/sushi3/user_feature.npy',allow_pickle=True)
    # user_feature=user_feature.astype(np.float32)
    # user_feature_gender=user_feature[:,0]
    # user_feature_gender=np.array(user_feature_gender).astype(np.float32)
    # user_feature_gender=user_feature_gender.reshape(-1,1)
