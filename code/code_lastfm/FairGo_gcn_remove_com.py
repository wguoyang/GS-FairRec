...
shiyanmiaoshu='LightGCN+GAN,lamd=0.2,第2轮开始测auc，gender+age,上次跑AUCF1降的少，增大lamd=2,性别和年龄之间权重1:2'
f = open('lightGCN_remove_com_result1.txt', 'a')
...
class InforMax(nn.Module):
    ...
    def forward(self, adj_pos1,user_batch,rating_batch,item_batch,flag_t):      
        ...
        w_f=[1,2]#[3,1.5,0.5]#[5,2.5,0.5]#[1,1,1]#[5,2.5,0.5]
        ...
        g_loss_all = 10 * loss_p_square - 20 * d_loss_all
